...
public class FoodLoggerGUI extends Application {
	...
	protected final String CSS = this.getClass().getResource("FoodLoggeGUICSS.css").toExternalForm();

	// Paths to FXML files
	protected static String PACKAGE = "view_controller/";
	protected static String FXML_LOGIN = "LoginScene.fxml";
	protected static String FXML_DASHBOARD = "UserDashboardScene.fxml";
	...
	protected static String FXML_STOMACHISSUES = "StomachIssuesScene.fxml";
	...
	protected static final int DIM_WIDTH_PHONE = 1170;
	protected static final int DIM_HEIGHT_PHONE = 2532;
